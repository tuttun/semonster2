...
public class SeMonsterGameTest {
  ...
  public void testdraw1() {
    ...
    SeMonsterGame mf = new SeMonsterGame(randomtestList);
    mf.addPlayer(testName);

    String testStatus = "Deck:" + testName + " HP:5" + "\n" + "スライム:レア度[0]\n" + "サハギン:レア度[0]\n" + "キングスライム:レア度[4]\n"
        + "シーサーペント:レア度[0]\n" + "ベルディア:レア度[3]\n" + "ドラゴン:レア度[0]\n" + "サハギン:レア度[1]\n" + "アクノロギア:レア度[4]\n";

    assertEquals(testStatus, mf.toString(testName));
  }
